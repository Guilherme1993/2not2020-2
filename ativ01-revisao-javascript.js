...
for (let i = 0; i < estadosNe.length; i++) {
    let densidade = densidadeDemografica(estadosNe[i].area, estadosNe[i].populacao)
...
let nomeEstados = []
nomeEstados.push('Sergipe')
nomeEstados.unshift('Alagoas')
nomeEstados.splice(1, 0, 'Rio Grande do Norte')
nomeEstados.splice(1, 0, 'Paraíba')
nomeEstados.splice(2, 0, 'Pernambuco')
nomeEstados.splice(1, 0, 'Ceará')
nomeEstados.splice(4, 0, 'Piauí')
nomeEstados.splice(2, 0, 'Maranhão')
nomeEstados.splice(1, 0, 'Bahia')